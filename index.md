---
layout: default
title: LeVonta | Cybersecurity Portfolio
---

<div class="hero">
  <div class="eyebrow">CYBERSECURITY • GRC • AI SECURITY • POST-QUANTUM CRYPTOGRAPHY</div>
...
<section id="projects" class="section">
  ...
  <div class="project-grid">
    ...
    <article class="project-card">
      ...
      <div class="project-content">
        <p class="project-type">SECURITY ASSESSMENT / PENETRATION TESTING</p>
        <h3>Rekall Corporation Penetration Test</h3>
        <p>
          Conducted an authorized multi-stage assessment of a simulated enterprise environment across web, Windows, and Linux systems. Identified vulnerabilities, validated exploitation paths, performed post-exploitation analysis, and documented remediation recommendations.
        </p>
        <div class="tags">
          <span>Nmap</span>
          <span>Nessus</span>
    ...
    <article class="project-card">
      ...
      <div class="project-content">
        <p class="project-type">CLOUD SECURITY</p>
        <h3>Azure Web Application Security</h3>
        <p>
          Implemented and documented web application security controls in Azure, including Application Gateway, WAF policy configuration, TLS concepts, custom rules, and cloud security architecture.
        </p>
        <div class="tags">
          <span>Azure</span>
          <span>WAF</span>
...
<section class="section">
  <div class="section-heading">
    ...
    <h2>Building depth across security and emerging technology.</h2>
  </div>
  ...
  <div class="project-grid">
    <article class="project-card">
      <div class="project-number">01</div>
      <div class="project-content">
        <p class="project-type">CERTIFICATION</p>
        <h3>CompTIA Security+</h3>
        <p>Validated foundational knowledge across threats, architecture, security operations, risk, and governance.</p>
      </div>
    </article>
